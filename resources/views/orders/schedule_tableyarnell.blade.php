...
<div class="tab-content mt-3">
    ...
    <div class="tab-pane fade show active" id="byMachine">
        ...
        <script>
            ...
            const isYarnell = window.currentLocation === 'yarnell';
            ...
            function updateButtonToggle(orderId, value, isReport) {
                ...
                console.log(`🔄 Sincronizado botón ${isReport ? 'report' : 'source'} en yarnell`);
            }
            ...
            window.addEventListener('storage', function(event) {
                ...
                switch (event.key) {
                    case 'location-change':
                        ...
                        if (data.location === 'yarnell') {
                            // Recargar toda la página porque la tabla no es AJAX
                            console.log("Cambio detectado en otra pestaña para location: yarnell. Recargando página..");
                            ...
                            if (row?.length) {
                                ...
                                console.log(`🧹 Orden ${data.orderId} removida de vista yarnell.`);
                            }
                        }
                        break;
