...
@section('css')
    <style>
        ...
        .costing-detail-table.has-tree-column td:nth-child(1) { width: 46px; }
        ...
        .costing-detail-table.has-tree-column td:nth-child(6) { width: 320px; }
        ...
        .costing-detail-table.no-tree-column td:nth-child(5) { width: 320px; }
